...
//	if($row==1)
//	{
	mysql_query("Insert into courses_student values('$coursecode','$desc','$startdate','$enddate','$coursetime','$profname','$studid')");
	echo "courses added to personal schedule".PHP_EOL;
